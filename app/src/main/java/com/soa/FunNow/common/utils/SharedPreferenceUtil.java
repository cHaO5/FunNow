...
public class SharedPreferenceUtil {
    ...
    public boolean getAutoLoc() {
        return mPrefs.getBoolean(AUTO_LOC, true);
    }

    public void setAutoLoc(boolean b) {
        mPrefs.edit().putBoolean(AUTO_LOC, b).apply();
    }

    public float getLA() {
        return mPrefs.getFloat(LA, (float) 31.291873);
    }

    public void setLA(float la) { mPrefs.edit().putFloat(LA, la).apply(); }

    public float getLONG() {
        return mPrefs.getFloat(LONG, (float) 121.220631);
    }

    public void setLONG(float longtitude) { mPrefs.edit().putFloat(LONG, longtitude).apply(); }
}
